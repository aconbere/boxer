...
var Collector = function (projectPath, outputPath, PreProcessor, PostProcessor, options) {
  ...
  if (this.options.verbose) { util.puts("processing: " + projectPath) }
}
...
Collector.prototype.collect = function () {
  if (this.options.verbose) util.puts("running collect")
...
Collector.prototype.processFiles = function () {
  if (this.options.verbose) util.puts("Processing Files")
...
Collector.prototype.publish = function () {
  if (this.options.verbose) util.puts("publishing to: " + this.outputPath)
  var that = this
